...
from hypergen.ui.project_paths import bundle_path
...
class WelcomeDialog(QDialog):
    ...
    def __init__(
        ...
        self.setWindowTitle("HyperGen")
        self.setMinimumSize(560, 420)

        title = QLabel("HyperGen")
    ...
    def refresh_projects(self) -> None:
        ...
        try:
            ...
            self.empty_label.setText(
                f"HyperGen could not read the project directory:\n{error}"
            )
        ...
        for path in entries:
            try:
                if path.is_dir() and path.suffix.casefold() == ".hypergen":
